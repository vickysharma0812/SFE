...
![Black-body radiation has a continuous frequency spectrum that depends only on the body's temperature (Planck's law).](https://www.ossila.com/cdn/shop/files/blackbody-spectrum-various-temperatures.svg?v=1670335899&width=848&height=452)

## Spectra of black body radiation {.smaller}

The spectrum has a peak at a characteristic frequency that shifts to higher frequencies with increasing temperature.

![The spectrum has a peak at a characteristic frequency that shifts to higher frequencies with increasing temperature](https://www.ossila.com/cdn/shop/files/blackbody-spectrum-various-temperatures.svg?v=1670335899&width=848&height=452)
...
![Blacksmiths judge workpiece temperatures by the colour of the glow](https://upload.wikimedia.org/wikipedia/commons/3/3e/Blacksmith_at_work.jpg)

![Blacksmiths chart](https://upload.wikimedia.org/wikipedia/commons/b/bd/Gluehfarben_no_language_horizontal.svg)
...
![Solar irradiance spectral distribution vs. black-body spectral distribution at 5800 K. The solar spectrum is the range of electromagnetic radiation emitted by the sun, extending from the ultraviolet to the infrared region.](https://www.ossila.com/cdn/shop/files/black-body-vs-solar-irradiance.svg?v=1670335975&width=848&height=452)
...
![Solar irradiance spectral distribution](https://www.ossila.com/cdn/shop/files/black-body-vs-solar-irradiance.svg?v=1670335975&width=848&height=452)
...
- The cooler bodies emits radiation of larger wavelengths. If these wavelengths belong to visible spectrum then we can see those bodies. [Interesting article on spectrum of various light source](https://micro.magnet.fsu.edu/primer/lightandcolor/lightsourcesintro.html)
- However, if the wavelengths are larger than the visible spectrum then we cannot see those bodies, and we need Infrared imaging (Thermography). [See the video on using Thermography to study forest canopy](https://www.youtube.com/watch?v=9HLdiJAZNTM)
...
![Earth's energy balance [Source NOAA](https://www.noaa.gov/jetstream/atmosphere/energy)](./figures/energy_balance.jpg)

## Earth's energy balance

![Earth's energy balance](https://upload.wikimedia.org/wikipedia/commons/b/bb/The-NASA-Earth%27s-Energy-Budget-Poster-Radiant-Energy-System-satellite-infrared-radiation-fluxes.jpg)
...
![Scattering of light](./figures/The_Solar_Spectrum-01.png)
...
## Energy balance in forest ecosystem {.smaller}
...
![Radiation patterns for a clearcut forest in Oregon, USA on a summer day; Source: Forest Ecology, An evidence based approach](./figures/c02f010.jpg)
...
## Forest help in maintaining soil temperature {.smaller}

![The temperature of the air in the forest in nothern Arizona, USA on a winter night](./figures/c02f011.jpg)
...
![The sunlight are approximately parallel when they arrive at Earth](./figures/the-solar-spectrum-zenith-angle.png)
...
## Tilt of the earth {.smaller}

![Tilt of the earth](./figures/the-solar-spectrum_I0-irradiance.png)
...
![The latitude, which receives sunlight at normal incidence, and hence the greatest intensity, varies depending on the time of year](./figures/the-solar-spectrum-tropic-of-cancer.png)


## Effect of slope on solar radiation {.smaller}

![The daily amount of incoming sunlight depends on the aspect of a site. In the Northern Hemisphere at a latitude of 43°, a hillside that faces toward the north at an angle of 25° receives almost no direct‐beam sunlight in winter, when a 25° hillside facing to the south receives 9 MJ m−2. The effect of aspect is small in mid‐summer.](./figures/c02f008.png)

## {.smaller}

![The amount of incoming radiation received by a site depends not only on latitude, slope angle and aspect, but also on whether nearby hillsides block sunlight (left). The shading effects in a mountainous landscape in northern Idaho reduces incoming sunlight by only a few percent on south‐facing slopes, but by an average of 30% on north‐facing slopes. The effect of slope combined with shading from surrounding hills resulted in a fourfold range of incoming solar radiation annually](./figures/c02f009.png)

## {.smaller}

![Daily comparisons of high and low temperatures at locations that differ by 1500 m in elevation showed a general pattern that also included specific days that were higher or lower than the trend. Some of the variation related to the moisture content of the air, especially on colder days, and other variation relates to cloudiness and shifting weather systems.](./figures/c02f014.jpg)

## {.smaller}


![The temperatures of the soil (10 cm below the O horizon) differed between north‐ and south‐facing aspects in this glacial valley in Colorado, USA (2750 m elevation), in part because of the effect of aspect on snow accumulation, retention, and time of melting.](./figures/c02f015.jpg)
